(function() {
    ...
    window.Waveform = Waveform = (function() {
        ...
        Waveform.prototype.updateSize = function(width, height) {
        ...
        Waveform.prototype.redraw = function() {
            ...
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                ...
                this.context.clearRect(t * i, middle - middle * d, t * 2, middle * d * 2);
                this.context.fillRect(t * i, middle - middle * d, t * 2, middle * d * 2);
                _results.push(i++);
            }
            return _results;
        };
        ...
        Waveform.prototype.updatePlayback = function(position, duration, eqData, waveformData) {
        ...
        Waveform.prototype.optionsForSyncedStream = function(options) {
            ...
            return {
                whileplaying: function() {
                    that.redraw();
                    that.updatePlayback(this.position, this.duration, this.eqData, this.waveformData);
                },
                    ...
                    if (!innerColorWasSet) {
                        ...
                        that.innerColor = function(x, y) {
                            if (x < stream.position / stream.durationEstimate) {
                                return options.playedColor || "rgba(0, 0, 0, 1.0 )";
                            } else if (x < stream.bytesLoaded / stream.bytesTotal) {
                                return options.loadedColor || "rgba(0, 255, 0, 0.8)";
                            } else {
        ...
        Waveform.prototype.dataParseComplete = function() {
            // Called when parsing of data is complete
        };
